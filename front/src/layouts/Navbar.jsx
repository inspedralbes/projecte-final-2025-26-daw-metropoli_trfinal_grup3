...
const Navbar = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 pointer-events-auto touch-none">
      {/* Nav Bar Background */}
      <div className="bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800 px-6 pt-2 pb-6 flex justify-between items-center relative shadow-[0_-5px_20px_rgba(0,0,0,0.05)] transition-colors duration-300 touch-none">
        {/* Left Links */}
        ...
        <div className="absolute left-1/2 -translate-x-1/2 -top-8">
          {isActive("/") ? (
            <div className="relative group">
              ...
              <button className="relative bg-gradient-to-br from-[#ff3355] to-[#cc1133] text-white w-20 h-20 rounded-full flex flex-col items-center justify-center shadow-2xl shadow-primary/40 transition-all duration-200 border-[6px] border-white dark:border-slate-900 ring-1 ring-slate-100 dark:ring-slate-800 pointer-events-none">
                <span className="material-symbols-outlined text-[40px] fill-1 leading-none drop-shadow-md">
                  map
                </span>
                <span className="text-[10px] font-black uppercase tracking-widest mt-0.5 drop-shadow-sm">
                  {t("nav.map")}
                </span>
              </button>
            </div>
