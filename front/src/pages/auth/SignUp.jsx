...
const SignUp = () => {
  ...
  if (step === "google-password") {
    return (
      <div className="relative flex min-h-screen w-full flex-col items-center justify-center p-6 overflow-hidden bg-gray-50 dark:bg-[#121011] transition-colors duration-300">
        {/* ── Back button ── */}
        <Link
          to="/"
        ...
        <div className="w-full max-w-md z-10 space-y-6">
          <div className="p-8 rounded-2xl shadow-2xl space-y-6 bg-white/90 dark:bg-[#12080a]/90 backdrop-blur-md border border-slate-200 dark:border-primary/15">
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100">
                Casi listo, {googleData?.nombre.split(" ")[0]}
              </h2>
              <p className="text-slate-500 dark:text-slate-400 text-sm">
                Crea una contraseña para terminar de configurar tu cuenta.
              </p>
            </div>

            <form onSubmit={handleGooglePasswordSubmit} className="space-y-5">
              {error && (
                <div className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400">
                  <span
    ...
    return (
      <div className="relative flex min-h-screen w-full flex-col items-center justify-center p-6 overflow-hidden bg-gray-50 dark:bg-[#121011] transition-colors duration-300">
        ...
        <div className="w-full max-w-md z-10 text-center space-y-6">
          <div className="p-8 rounded-2xl shadow-2xl space-y-6 bg-white/90 dark:bg-[#12080a] backdrop-blur-md border border-slate-200 dark:border-primary/15">
              ...
              <>
                ...
                <div>
                  ...
                  <p className="mt-2 text-slate-500 dark:text-slate-400 text-sm leading-relaxed">
                    Te hemos enviado un <strong>código de 6 dígitos</strong>.
                    Introdúcelo aquí debajo para activar tu cuenta.
                  </p>
                </div>
                ...
                <div className="pt-4 border-t border-slate-100 dark:border-slate-800">
                  <p className="text-slate-400 dark:text-slate-500 text-xs text-left">
                    ¿No ves el email? Revisa la carpeta de <strong>spam</strong>{" "}
                    o correo no deseado.
                  </p>
                  <button
        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="text-center">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
              Create your account for exclusive track access
            </p>
          </div>
        </div>
