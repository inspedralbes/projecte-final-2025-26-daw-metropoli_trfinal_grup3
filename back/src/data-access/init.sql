...
-- Actividad inicial para usuario 2 (o el que se use para pruebas)
-- Asumiendo que el usuario actual es el 1 o el 2 en las pruebas del usuario
INSERT INTO usuario_actividad (id_usuario, tipo, valor, id_referencia, fecha) VALUES
(2, 'poi_visitado', 0, 1, DATE_SUB(NOW(), INTERVAL 5 DAY)),
(2, 'poi_visitado', 0, 2, DATE_SUB(NOW(), INTERVAL 4 DAY)),
(2, 'ruta_completada', 1.5, NULL, DATE_SUB(NOW(), INTERVAL 3 DAY)),
(2, 'ruta_completada', 2.8, NULL, DATE_SUB(NOW(), INTERVAL 2 DAY)),
(2, 'ruta_completada', 0.9, NULL, DATE_SUB(NOW(), INTERVAL 1 DAY)),
(2, 'ruta_completada', 3.2, NULL, NOW())
